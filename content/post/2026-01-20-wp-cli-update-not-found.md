...
description: "Solving issues with upgrading Wordpress with WP-CLI"
featured: true
draft: false
toc: false
#menu: main
...
thumbnail: "/logos/wp-cli-logo-inverted.png" # Sets thumbnail image appearing inside card on homepage.
shareImage: "/logos/wp-cli-logo-inverted.png" # Designate a separate image for social media sharing.
